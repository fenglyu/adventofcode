...
var (
	CARDS      = []uint8{'J', '2', '3', '4', '5', '6', '7', '8', '9', 'T', 'Q', 'K', 'A'}
...
func (h *Hand) String() string {
	return fmt.Sprintf("Cards: %s, Bid: %d, Type: %v", h.Cards, h.Bid, h.Type)
}
...
func genLists(bucket []uint8) ([]uint8, []uint8) {
	var pairs []IndexOccurrence

	for i, v := range bucket[1:] {
		if v > 0 {
